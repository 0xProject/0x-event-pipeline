...
const createTable = ` create table events_polygon.paraswap_swapped_v5_events
(
...
create index paraswap_swapped_v5_events_transaction_transaction_hash_index
    on events_polygon.paraswap_swapped_v5_events (transaction_hash);

create index paraswap_swapped_v5_events_transaction_block_number_index
    on events_polygon.paraswap_swapped_v5_events (block_number);
`;
...
const dropTable = `DROP TABLE events_polygon.paraswap_swapped_v5_events;`;

const dropIndexes = `
    DROP INDEX events_polygon.paraswap_swapped_v5_events_transaction_transaction_hash_index;
    DROP INDEX events_polygon.paraswap_swapped_v5_events_transaction_block_number_index;
`;

export class PolygonCreateParaswapSwappedV5EventTable1633715347000 implements MigrationInterface {
