...
const createTable = ` create table events_polygon.oneinch_swapped_v4_events
(
...
create index oneinch_swapped_v4_events_transaction_transaction_hash_index
    on events_polygon.oneinch_swapped_v4_events (transaction_hash);

create index oneinch_swapped_v4_events_transaction_block_number_index
    on events_polygon.oneinch_swapped_v4_events (block_number);
`;
...
FROM events_polygon.oneinch_swapped_v3_events
UNION ALL
SELECT '1inch'::text AS competitor,
...
FROM events_polygon.oneinch_swapped_v4_events
UNION ALL
SELECT 'Slingshot'::text AS competitor,
  slingshot_trade_events.observed_timestamp,
  slingshot_trade_events.contract_address,
  slingshot_trade_events.transaction_hash,
  slingshot_trade_events.transaction_index,
  slingshot_trade_events.log_index,
  slingshot_trade_events.block_hash,
  slingshot_trade_events.block_number,
  slingshot_trade_events.from_token,
  slingshot_trade_events.to_token,
  slingshot_trade_events.from_token_amount,
  slingshot_trade_events.to_token_amount,
  slingshot_trade_events."from",
  slingshot_trade_events."to"
...
FROM events_polygon.paraswap_swapped_v5_events;
`;
const dropTable = `DROP TABLE events_polygon.oneinch_swapped_v4_events;`;

const dropIndexes = `
    DROP INDEX events_polygon.oneinch_swapped_v4_events_transaction_transaction_hash_index;
    DROP INDEX events_polygon.oneinch_swapped_v4_events_transaction_block_number_index;
    DROP INDEX events_polygon.oneinch_swapped_v4_events_transaction_contract_addres_index;
`;

export class PolygonCreateOneinchSwappedV4EventTable1640717972000 implements MigrationInterface {
