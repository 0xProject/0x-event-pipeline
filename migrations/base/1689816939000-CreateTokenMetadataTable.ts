...
const downQuery = `
DROP TABLE events_base.token_metadata;
`;

const upQuery = `
CREATE TABLE events_base.tokens_metadata (
...
CREATE INDEX tokens_metadata_type_idx ON events_base.tokens_metadata USING btree (type);

INSERT INTO events_base.tokens_metadata (observed_timestamp,address,"type",symbol,"name","decimals")
