...
function parseStakingPoolMetadata(poolMetadataResponse: PoolMetadataResponse, poolId: string): StakingPoolMetadata {
    ...
    stakingPoolMetadata.website = poolMetadataResponse.website_url === undefined ? null : poolMetadataResponse.website_url;
    ...
    stakingPoolMetadata.logoUrl = poolMetadataResponse.logo_img === undefined ? null : baseGithubLogoUrl.concat(poolMetadataResponse.logo_img);
