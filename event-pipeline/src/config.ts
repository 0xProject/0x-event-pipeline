import {
    ...
    DEFAULT_BLOCKS_REORG_CHECK_RECEIPTS,
} from './constants';
...
export const BLOCKS_REORG_CHECK_RECEIPTS = process.env.BLOCKS_REORG_CHECK_RECEIPTS
    ? parseInt(process.env.BLOCKS_REORG_CHECK_RECEIPTS, 10)
    : DEFAULT_BLOCKS_REORG_CHECK_RECEIPTS;
