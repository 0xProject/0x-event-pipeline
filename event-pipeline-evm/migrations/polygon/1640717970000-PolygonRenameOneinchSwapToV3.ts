...
const renameTable = `ALTER TABLE events_polygon.oneinch_swapped_events RENAME TO oneinch_swapped_v3_events`;
...
export class PolygonRenameOneinchSwapToV31640717970000 implements MigrationInterface {
