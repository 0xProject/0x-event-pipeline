...
const downQuery = `
DROP TABLE events_optimism.token_metadata;
`;

const upQuery = `
CREATE TABLE events_optimism.tokens_metadata (
...
CREATE INDEX tokens_metadata_type_idx ON events_optimism.tokens_metadata USING btree (type);

INSERT INTO events_optimism.tokens_metadata (observed_timestamp,address,"type",symbol,"name","decimals")
