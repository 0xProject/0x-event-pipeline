...
const createTable = ` create table events_polygon.paraswap_swapped_events
(
...
create index paraswap_swapped_events_transaction_transaction_hash_index
    on events_polygon.paraswap_swapped_events (transaction_hash);

create index paraswap_swapped_events_transaction_block_number_index
    on events_polygon.paraswap_swapped_events (block_number);

create index paraswap_swapped_events_transaction_contract_addres_index
    on events_polygon.paraswap_swapped_events (contract_address);
`;
const dropTable = `DROP TABLE events_polygon.paraswap_swapped_events;`;

const dropIndexes = `
    DROP INDEX events_polygon.paraswap_swapped_events_transaction_transaction_hash_index;
...
export class PolygonCreateParaswapSwappedEventTable1623777079129 implements MigrationInterface {
