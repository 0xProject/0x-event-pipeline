...
const downQuery = `
DROP TABLE events_ropsten.token_metadata;
`;

const upQuery = `
CREATE TABLE events_ropsten.tokens_metadata (
...
CREATE INDEX tokens_metadata_type_idx ON events_ropsten.tokens_metadata USING btree (type);

INSERT INTO events_ropsten.tokens_metadata (observed_timestamp,address,"type",symbol,"name","decimals")
