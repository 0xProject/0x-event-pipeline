...
@Entity({ name: 'open_ocean_swapped_v1_events' })
export class OpenOceanSwappedV1Event extends Event {
    ...
    @Column({ name: 'expected_from_token_amount', type: 'numeric', transformer: bigNumberTransformer })
    public expectedFromTokenAmount!: BigNumber;
    @Column({ name: 'min_to_token_amount', type: 'numeric', transformer: bigNumberTransformer })
    public minToTokenAmount!: BigNumber;
}
